...
public class ArrayUtil {
  ...
  static final int EX_CHUNK_INT = 1024;
  ...
  public static int indexToInsertPos(final int index) {
    if (index >= 0) {
      throw new IllegalArgumentException("index > 0 can not insert");
    }
  ...
  public static int[] append(int[] src, int[] dest){
...
//
//    int[] src = new int[]{4, 5, 6};
//    int[] dest = new int[] {1, 2, 3};
//
//    int[] result = append(src, dest);
//
//    println(result);
